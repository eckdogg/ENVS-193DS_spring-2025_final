...
ggplot() +
  ...
  geom_line(data = mod_preds,
            aes(x = x,
                ...
                color = group),
            linewidth = 1) +  
  scale_y_continuous("Swift parrot presence",
                   limits = c(0, 1),
                   breaks = c(0, 1),
                   labels = c("No", "Yes")) +
...
Points represent observations of swift parrot presence at individual nest boxes at various distances from forest edges (m). Lines represent the predicted probability of swift parrot presence based on distance from forest edge. Colors represent seasons (blue: 2016, green: 2019).